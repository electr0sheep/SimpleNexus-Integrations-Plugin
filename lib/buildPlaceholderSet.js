...
module.exports = {
  buildPlaceholderSet: function () {
    ...
    try {
      ...
      data = fs.readFileSync(atom.packages.getPackageDirPaths()[0] + '/SimpleNexus-Integrations-Plugin/simplenexus/simplenexus.com/util_replace_placeholders_spec.rb')
    }
    catch (err) {
      atom.notifications.addError("buildPlaceholderSet.js:\n\nUnable to open util_replace_placeholders_spec.rb", {dismissable: true})
    ...
    // user_loan_app
    try {
      data = fs.readFileSync(atom.packages.getPackageDirPaths()[0] + '/SimpleNexus-Integrations-Plugin/simplenexus/simplenexus.com/user_loan_app.rb')
    }
    catch (err) {
      atom.notifications.addError("buildPlaceholderSet.js:\n\nUnable to open user_loan_app.rb", {dismissable: true})
      atom.notifications.addError(err.toString(), {dismissable: true})
      return
    }
    dataString = data.toString()
    ...
    // custom_form
    try {
      data = fs.readFileSync(atom.packages.getPackageDirPaths()[0] + '/SimpleNexus-Integrations-Plugin/simplenexus/simplenexus.com/custom_form.rb')
    }
    catch (err) {
      atom.notifications.addError("buildPlaceholderSet.js:\n\nUnable to open custom_form.rb", {dismissable: true})
      atom.notifications.addError(err.toString(), {dismissable: true})
      return
    }
    dataString = data.toString()
    ...
    try {
      data = fs.readFileSync(atom.packages.getPackageDirPaths()[0] + '/SimpleNexus-Integrations-Plugin/simplenexus/simplenexus.com/time_placeholder_replacement.rb')
    }
    catch (err) {
      atom.notifications.addError("buildPlaceholderSet.js:\n\nUnable to open time_placeholder_replacement.rb", {dismissable: true})
      atom.notifications.addError(err.toString(), {dismissable: true})
      return
    }
    dataString = data.toString()
    ...
    // lending_qb
    try {
      data = fs.readFileSync(atom.packages.getPackageDirPaths()[0] + '/SimpleNexus-Integrations-Plugin/simplenexus/simplenexus.com/lending_qb.rb')
    }
    catch (err) {
      atom.notifications.addError("buildPlaceholderSet.js:\n\nUnable to open lending_qb.rb", {dismissable: true})
      atom.notifications.addError(err.toString(), {dismissable: true})
      return
    }
    dataString = data.toString()
    ...
    try {
      ...
      atom.notifications.addError("buildPlaceholderSet.js:\n\nUnable to open default_json_fields.json", {dismissable: true})
      atom.notifications.addError(err.toString(), {dismissable: true})
      return
    }
