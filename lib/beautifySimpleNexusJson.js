  ...
  beautifySimpleNexusJson: function (jsonFields) {
    ...
    if (editor = atom.workspace.getActiveTextEditor()) {
      ...
      for (var i = 0; i < cleanedJson.fields.length; i++) {
        ...
        // check for no title
        if (currentField.type != "info" && currentField.type != "verification_of_assets" && (currentField.title === undefined || currentField.title == "")) {
        ...
        if (currentField.type == "info" && currentField.required && currentField.required == true) {
