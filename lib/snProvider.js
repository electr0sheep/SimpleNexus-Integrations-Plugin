...
const snLogoImageURL = '<image src="' + atom.packages.getPackageDirPaths()[0] + '/sn-integrations-plugin/simplenexus/simplenexus-icon-transparent.png' + '"/>'
const lqbLogoImageURL = '<image src="' + atom.packages.getPackageDirPaths()[0] + '/sn-integrations-plugin/simplenexus/lqb.png' + '"/>'
const encompassLogoImageURL ='<image src="' + atom.packages.getPackageDirPaths()[0] + '/sn-integrations-plugin/simplenexus/encompass.png' + '"/>'
const encomplqbLogoImageURL = '<image src="' + atom.packages.getPackageDirPaths()[0] + '/sn-integrations-plugin/simplenexus/lqb-encompass.png' + '"/>'
const nmmLogoImageURL = '<image src="' + atom.packages.getPackageDirPaths()[0] + '/sn-integrations-plugin/simplenexus/nmm.png' + '"/>'
