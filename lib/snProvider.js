...
const snLogoImageURL = '<image src="' + atom.packages.getPackageDirPaths()[0] + '/sn-integrations-plugin/simplenexus/images/simplenexus-icon-transparent.png' + '"/>'
const lqbLogoImageURL = '<image src="' + atom.packages.getPackageDirPaths()[0] + '/sn-integrations-plugin/simplenexus/images/lqb.png' + '"/>'
const encompassLogoImageURL ='<image src="' + atom.packages.getPackageDirPaths()[0] + '/sn-integrations-plugin/simplenexus/images/encompass.png' + '"/>'
const encomplqbLogoImageURL = '<image src="' + atom.packages.getPackageDirPaths()[0] + '/sn-integrations-plugin/simplenexus/images/lqb-encompass.png' + '"/>'
const nmmLogoImageURL = '<image src="' + atom.packages.getPackageDirPaths()[0] + '/sn-integrations-plugin/simplenexus/images/nmm.png' + '"/>'
